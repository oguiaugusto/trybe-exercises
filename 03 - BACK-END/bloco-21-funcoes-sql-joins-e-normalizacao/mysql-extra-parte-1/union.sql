...
UNION ALL SELECT first_name, last_name FROM sakila.actor;
...
) UNION (SELECT first_name FROM sakila.actor
...
UNION (SELECT UCASE(first_name) FROM sakila.staff LIMIT 1) UNION
...
UNION (SELECT first_name, last_name FROM sakila.actor LIMIT 60)
LIMIT 15 OFFSET 45;
