import json
import pytest
from pokemon import retrieve_pokemons_by_type_reader
...
def test_retrieve_pokemons_by_type_reader(grass_type_pokemon, water_type_pokemon):
    ...
    assert grass_type_pokemon in retrieve_pokemons_by_type_reader("Grass", fake_file)
